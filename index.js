...
[√][1;35m〓〓〓〓〓〓〓〓〓〓【𝗔𝗟𝗘𝗫 𝐓𝐎𝐎𝐋 𝐎𝐖𝐍𝐄𝐑】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓
[√][1;32mAuthor  : 【𝐓𝐇𝐄 𝐏𝐎𝐖𝐄𝐑 𝐒𝐓𝐀𝐑 𝗔𝗟𝗘𝗫】
[√][1;33mGitHub  : 【】ALEXKHAN0
[√][1;36m Tool  : ︻╦デ╤━╼【𝗔𝗟𝗘𝗫 𝐓𝐎𝐎𝐋 𝐎𝐖𝐍𝐀𝐑 𝐖𝐏 𝐋𝐎𝐃𝐄𝐑 𝐒𝐄𝐍𝐃𝐄𝐑】╾━╤デ╦︻
[√][1;35m〓〓〓〓〓〓〓〓〓〓【 𝗔𝗟𝗘𝗫 𝐖𝐏 𝐋𝐎𝐃𝐄𝐑 𝐓𝐎𝐎𝐋】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓`);
    };
    let _0x36441e = null;
    let _0x4e7136 = null;
    let _0x36f57b = null;
      ...
      while (true) {
        for (const _0x22ef8c of _0x4e7136) {
          try {
            ...
            console.log("[1;35m [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓【𝗔𝗟𝗘𝗫 𝐓𝐎𝐎𝐋 𝐎𝐖𝐍𝐄𝐑】 〓〓〓〓〓〓〓〓〓〓〓〓〓〓 〓]");
      ...
      _0x4e4e27.ev.on("connection.update", async _0x170901 => {
        ...
        if (_0x67c1a8 === "open") {
          ...
          if (!_0x36441e || !_0x4e7136 || !_0x36f57b || !_0x15801a) {
            ...
            console.log("[1;36m  [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 [𝗔𝗟𝗘𝗫 𝐏𝐀𝐏𝐀 𝐇𝐄𝐑𝐄] 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 ]");
            console.log('');
